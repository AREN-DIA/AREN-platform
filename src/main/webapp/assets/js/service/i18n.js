...
const messages = {
  'fr-FR': {
    ...
    invite_to_debate: "Inviter à débattre",
    configuration: {
      advanced: "Avancée",
      base: {
      ...
      default: {
        ...
        "institution-id": "Id de l'institution par défaut"
      },
      authentication: {
        title: "Paramètres de sécurité",
        jwt: {
          secret: "JWT secret <small>(si changé tous les utilisateur⋅ices seront déconnecté⋅es)</small>",
          issuer: "JWT issuer <small>(par défaut, identique au reverse proxy)</small>",
          audience: "JWT audience <small>(par défaut, identique au reverse proxy)</small>",
      ...
      rules: {
        title: "Règles",
        remove: {
          categoryWithDocuments: "Autoriser la suppression de catégorie avec documents",
          documentWithDebates: "Autoriser la suppression de document avec débats",
          debatesWithComments: "Autoriser la suppression de débat avec commentaires",
        }
      }
    },
    helper: {
      ...
      cas_login: "Connectez-vous via le système CAS de l'ENT",
      ...
      cannot_add_institution_user: "Vous ne pouvez pas ajouter un⋅e utilisateur⋅rice d'un groupe institutionnel",
      remove_user: "Supprimer l'utilisateur⋅rice",
      remove_permanent_user: "Supprimer définitivement l'utilisateur⋅rice",
      cannot_remove_institution_user: "Vous ne pouvez pas supprimer un⋅e utilisateur⋅rice d'un groupe institutionnel",
      cannot_create_institution_user: "Vous ne pouvez pas créer un⋅e utilisateur⋅rice dans un établissement",
      ...
      team_already_in_debate: "Le groupe fait déjà partie du débat",
      ...
      delete_document_warning: "Tous les débats qui lui sont liés seront également effacés.",
      ...
      delete_permanent_user_warning: "Cette action est irréversible<br>Si l'utilisateur⋅rice a déjà posté des arguments, cette action échouera.<br>Êtes-vous sûr⋅e de vouloir continuer ?",
      ...
      user_created_email: "Un e-mail a été envoyé à l'adresse saisie, cliquez sur le lien fourni pour activer votre compte",
      ...
      tag_input_explanations: "Appuyez sur Entrée pour valider",
      report_comment: "Signaler l'argument",
      report_details: "Vous vous apprêtez à signaler un message à la modération.<p>Un message doit être signalé pour les raisons suivantes : <ul class='browser-default'><li>propos inappropriés ou insultants (par ex. : atteinte à la dignité, discours haineux, menaces)</li><li>oppression systémique (par ex. : racisme, sexisme, homophobie)</li><li>contenu commercial (par ex. : publicité, promotion, appel d'offre)</li><li>autres propos sans lien aucun avec le débat en cours</li></ul></p>Êtes-vous sûr⋅e de vouloir continuer ?",
      export: "Votre téléchargement va débuter... Si rien ne se passe <a href='ws/debates/{debateId}/export'>cliquez ici</a>",
      password_forgotten: "<p>Vous avez oublié votre mot de passe ? Pas de problème !</p><p>Saisissez votre adresse e-mail ou votre pseudonyme.</p>",
      password_forgotten_email: "<p>Si vous êtes inscrit⋅e, un e-mail expliquant la procédure de réinitialisation sera envoyé à l'adresse associée à votre compte.</p><p>Vérifiez votre boîte mail.</p>",
      ...
      with_hypostases: "Propose une sélection d'hypostase pour les arguments",
      ...
      update_tags: "<p>Ce processus peut être long, il sera exécuté en arrière-plan et vous n'aurez pas la possibilité de modifier les tags pendant ce temps.</p><p>Voulez-vous continuer ?</p>",
      tag_update_success: "La mise à jour des tags est un succès.",
      active: "Le débat peut être commenté",
      open_public: "Le débat sera accessible par n'importe quel utilisateur⋅ice, même non connecté⋅e",
      404: "Après long débat, il est avéré que cette page n'existe pas.",
      redirect_home: "Vous allez être automatiquement redirigé vers la page d'accueil dans..."
    },
    notification: {
      team_added_to_debate: "Votre groupe {teamName} participe au débat {debateName}.",
      invited_to_debate: "Vous êtes invité⋅e au débat {debateName}.",
      comment_answered: "{firstName} {lastName} a répondu à votre argument.",
      comment_moderated: "Votre argument a été modéré sur le débat {debateName}.",
      comment_signaled: "Votre argument a été signalé sur le débat {debateName}."
    },
    error: {
      ...
      duplicate_key: "La clé {keyName} avec la valeur {keyValue} existe déjà.",
      ...
      aaf_import: "<p>Erreur lors de l'import AAF.</p><p>Il est probable que votre fichier soit corrompu ou n'entre pas dans les standards de l'application.</p>",
      tag_update_success: "<p>Erreur lors de la mise à jour des tags.</p><p>Contactez un⋅e admin.</p>"
    },
    menu: {
    ...
    comment: {
      ...
      select_hypostases: "Sélectionnez une ou plusieurs hypostases dans la liste",
      expert: "Expert"
    },
    argumentation_check: {
    ...
    documentation: {
      ...
      notification_panel: "<h1>Restez informé⋅e des débats auxquels vous participez.</h1><p>Vous recevrez une notification lorsqu'une réponse est postée à un de vos arguments et lorsque vous avez été invité⋅e à un nouveau débat.</p>",
      create_debate_with: "<h1>Débattre avec</h1><p>Sélectionnez les personnes et groupes qui pourront participer au débat. Si rien n'est sélectionné le débat sera public, accessible à tou⋅tes</p>",
      create_debate_document: "<h1>Débattre sur</h1><p>Sélectionnez le document sur lequel vous désirez porter le débat</p>",
      create_debate_recap: "<h1>Récapitulatif</h1><p>Vérifiez les informations saisies et sélectionnez des paramètres avancés</p>",
      ...
      debate_themes: "<h1>Thèmes du débat</h1><p>Saisissez un mot ou un groupe de mots définissant un thème et appuyez sur <b>Entrée</b> pour valider. Les arguments avec le thème saisi seront alors calculés et mis en lien avec celui-ci.</p><p>Vous pouvez supprimer un thème en cliquant sur <i class='close material-icons'>delete_forever</i></p>",
      debate_scraps: "<h1>Textes les plus sélectionnés</h1><p>Voici la liste des portions de texte du document les plus sélectionnées pour argumenter. Chaque sélection est reliée aux arguments qui la contiennent.</p>",
